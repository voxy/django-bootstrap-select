...
Ready to contribute? Here's how to set up `django-bootstrap-select` for local development.

1. Fork the `django-bootstrap-select` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/django-bootstrap-select.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv django-bootstrap-select
    $ cd django-bootstrap-select/
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_bootstrap_select
